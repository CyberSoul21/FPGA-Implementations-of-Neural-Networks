...
/* Soc_gpio */
#define CSR_SOC_GPIO_BASE (CSR_BASE + 0x0L)
#define CSR_SOC_GPIO_LED_REG_ADDR (CSR_BASE + 0x0L)
#define CSR_SOC_GPIO_LED_REG_SIZE 1
static inline uint32_t Soc_gpio_LED_REG_read(void) {
	return csr_read_simple(CSR_BASE + 0x0L);
}
static inline void Soc_gpio_LED_REG_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x0L);
}
#define CSR_SOC_GPIO_SW_REG_ADDR (CSR_BASE + 0x4L)
#define CSR_SOC_GPIO_SW_REG_SIZE 1
static inline uint32_t Soc_gpio_SW_REG_read(void) {
	return csr_read_simple(CSR_BASE + 0x4L);
}
#define CSR_SOC_GPIO_EV_STATUS_ADDR (CSR_BASE + 0x8L)
#define CSR_SOC_GPIO_EV_STATUS_SIZE 1
static inline uint32_t Soc_gpio_ev_status_read(void) {
	return csr_read_simple(CSR_BASE + 0x8L);
}
#define CSR_SOC_GPIO_EV_STATUS_INTERRUP_PER_OFFSET 0
#define CSR_SOC_GPIO_EV_STATUS_INTERRUP_PER_SIZE 1
static inline uint32_t Soc_gpio_ev_status_interrup_per_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t Soc_gpio_ev_status_interrup_per_read(void) {
	uint32_t word = Soc_gpio_ev_status_read();
	return Soc_gpio_ev_status_interrup_per_extract(word);
}
#define CSR_SOC_GPIO_EV_PENDING_ADDR (CSR_BASE + 0xcL)
#define CSR_SOC_GPIO_EV_PENDING_SIZE 1
static inline uint32_t Soc_gpio_ev_pending_read(void) {
	return csr_read_simple(CSR_BASE + 0xcL);
}
static inline void Soc_gpio_ev_pending_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0xcL);
}
#define CSR_SOC_GPIO_EV_PENDING_INTERRUP_PER_OFFSET 0
#define CSR_SOC_GPIO_EV_PENDING_INTERRUP_PER_SIZE 1
static inline uint32_t Soc_gpio_ev_pending_interrup_per_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t Soc_gpio_ev_pending_interrup_per_read(void) {
	uint32_t word = Soc_gpio_ev_pending_read();
	return Soc_gpio_ev_pending_interrup_per_extract(word);
}
static inline uint32_t Soc_gpio_ev_pending_interrup_per_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void Soc_gpio_ev_pending_interrup_per_write(uint32_t plain_value) {
	uint32_t oldword = Soc_gpio_ev_pending_read();
	uint32_t newword = Soc_gpio_ev_pending_interrup_per_replace(oldword, plain_value);
	Soc_gpio_ev_pending_write(newword);
}
#define CSR_SOC_GPIO_EV_ENABLE_ADDR (CSR_BASE + 0x10L)
#define CSR_SOC_GPIO_EV_ENABLE_SIZE 1
static inline uint32_t Soc_gpio_ev_enable_read(void) {
	return csr_read_simple(CSR_BASE + 0x10L);
}
static inline void Soc_gpio_ev_enable_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x10L);
}
#define CSR_SOC_GPIO_EV_ENABLE_INTERRUP_PER_OFFSET 0
#define CSR_SOC_GPIO_EV_ENABLE_INTERRUP_PER_SIZE 1
static inline uint32_t Soc_gpio_ev_enable_interrup_per_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t Soc_gpio_ev_enable_interrup_per_read(void) {
	uint32_t word = Soc_gpio_ev_enable_read();
	return Soc_gpio_ev_enable_interrup_per_extract(word);
}
static inline uint32_t Soc_gpio_ev_enable_interrup_per_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void Soc_gpio_ev_enable_interrup_per_write(uint32_t plain_value) {
	uint32_t oldword = Soc_gpio_ev_enable_read();
	uint32_t newword = Soc_gpio_ev_enable_interrup_per_replace(oldword, plain_value);
	Soc_gpio_ev_enable_write(newword);
}
