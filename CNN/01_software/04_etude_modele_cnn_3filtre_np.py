# -*- coding: utf-8 -*-
## 
# @file    04_etude_modele_cnn_1filtre_np.py 
# @brief   Étudier l'inference d'un modèle quantizée avec numpy.
# @details Module pour calculer les résultats de chaque couche en utilisant
#          numpy. Le modèle étudie c'est une CNN avec 1 filtre pour classifier 
#          Mnist. Il peut sert à identifier comment faire les operations de
#          l'inference avec Numpy.
...
print(" Flatten                               ");
print("************************************** ");
flatten_aux = np.append(mp_0, mp_1); flatten_aux = np.append(flatten_aux, mp_2);
#print(flatten_aux); 
