//--------------------------------------------------------------------------------
// Auto-generated by Migen (3ffd64c) & LiteX (080ecad5) on 2021-08-18 12:32:58
//--------------------------------------------------------------------------------
...
#define CSR_ACCQUANT_CNN_WEN_IMAGE_ADDR (CSR_BASE + 0x8L)
...
#define CSR_ACCQUANT_CNN_WADD_IMAGE_ADDR (CSR_BASE + 0xcL)
...
#define CSR_ACCQUANT_CNN_WDATA_IMAGE_ADDR (CSR_BASE + 0x10L)
...
#define CSR_ACCQUANT_CNN_WEN_MAX_ADDR (CSR_BASE + 0x14L)
#define CSR_ACCQUANT_CNN_WEN_MAX_SIZE 1
static inline uint32_t AccQuant_cnn_WEN_MAX_read(void) {
	return csr_read_simple(CSR_BASE + 0x14L);
}
static inline void AccQuant_cnn_WEN_MAX_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x14L);
}
#define CSR_ACCQUANT_CNN_RADD_MEMORY_MAX_ADDR (CSR_BASE + 0x18L)
#define CSR_ACCQUANT_CNN_RADD_MEMORY_MAX_SIZE 1
static inline uint32_t AccQuant_cnn_RADD_MEMORY_MAX_read(void) {
	return csr_read_simple(CSR_BASE + 0x18L);
}
static inline void AccQuant_cnn_RADD_MEMORY_MAX_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x18L);
}
#define CSR_ACCQUANT_CNN_DATA_MAX_OUT_ADDR (CSR_BASE + 0x1cL)
#define CSR_ACCQUANT_CNN_DATA_MAX_OUT_SIZE 1
static inline uint32_t AccQuant_cnn_DATA_MAX_OUT_read(void) {
	return csr_read_simple(CSR_BASE + 0x1cL);
}
#define CSR_ACCQUANT_CNN_MAX_OK_ADDR (CSR_BASE + 0x20L)
...
#define CSR_ACCQUANT_CNN_MEM_OK_ADDR (CSR_BASE + 0x24L)
