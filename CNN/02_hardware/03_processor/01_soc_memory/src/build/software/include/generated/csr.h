//--------------------------------------------------------------------------------
// Auto-generated by Migen (3ffd64c) & LiteX (080ecad5) on 2021-08-04 03:16:32
//--------------------------------------------------------------------------------
...
/* Wrapper */
#define CSR_WRAPPER_BASE (CSR_BASE + 0x0L)
#define CSR_WRAPPER_ADDR_REG_ADDR (CSR_BASE + 0x0L)
#define CSR_WRAPPER_ADDR_REG_SIZE 1
static inline uint32_t Wrapper_ADDR_REG_read(void) {
	return csr_read_simple(CSR_BASE + 0x0L);
}
static inline void Wrapper_ADDR_REG_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x0L);
}
#define CSR_WRAPPER_DATA_IN_REG_ADDR (CSR_BASE + 0x4L)
#define CSR_WRAPPER_DATA_IN_REG_SIZE 1
static inline uint32_t Wrapper_DATA_IN_REG_read(void) {
	return csr_read_simple(CSR_BASE + 0x4L);
}
static inline void Wrapper_DATA_IN_REG_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x4L);
}
#define CSR_WRAPPER_MEM_OK_REG_ADDR (CSR_BASE + 0x8L)
#define CSR_WRAPPER_MEM_OK_REG_SIZE 1
static inline uint32_t Wrapper_MEM_OK_REG_read(void) {
	return csr_read_simple(CSR_BASE + 0x8L);
}
static inline void Wrapper_MEM_OK_REG_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x8L);
}
#define CSR_WRAPPER_DATA_OUT_REG_ADDR (CSR_BASE + 0xcL)
#define CSR_WRAPPER_DATA_OUT_REG_SIZE 1
static inline uint32_t Wrapper_DATA_OUT_REG_read(void) {
	return csr_read_simple(CSR_BASE + 0xcL);
}
#define CSR_WRAPPER_EN_REG_ADDR (CSR_BASE + 0x10L)
#define CSR_WRAPPER_EN_REG_SIZE 1
static inline uint32_t Wrapper_EN_REG_read(void) {
	return csr_read_simple(CSR_BASE + 0x10L);
}
static inline void Wrapper_EN_REG_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x10L);
}
#define CSR_WRAPPER_EV_STATUS_ADDR (CSR_BASE + 0x14L)
#define CSR_WRAPPER_EV_STATUS_SIZE 1
static inline uint32_t Wrapper_ev_status_read(void) {
	return csr_read_simple(CSR_BASE + 0x14L);
}
#define CSR_WRAPPER_EV_STATUS_INTERRUP_PER_OFFSET 0
#define CSR_WRAPPER_EV_STATUS_INTERRUP_PER_SIZE 1
static inline uint32_t Wrapper_ev_status_interrup_per_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t Wrapper_ev_status_interrup_per_read(void) {
	uint32_t word = Wrapper_ev_status_read();
	return Wrapper_ev_status_interrup_per_extract(word);
}
#define CSR_WRAPPER_EV_PENDING_ADDR (CSR_BASE + 0x18L)
#define CSR_WRAPPER_EV_PENDING_SIZE 1
static inline uint32_t Wrapper_ev_pending_read(void) {
	return csr_read_simple(CSR_BASE + 0x18L);
}
static inline void Wrapper_ev_pending_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x18L);
}
#define CSR_WRAPPER_EV_PENDING_INTERRUP_PER_OFFSET 0
#define CSR_WRAPPER_EV_PENDING_INTERRUP_PER_SIZE 1
static inline uint32_t Wrapper_ev_pending_interrup_per_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t Wrapper_ev_pending_interrup_per_read(void) {
	uint32_t word = Wrapper_ev_pending_read();
	return Wrapper_ev_pending_interrup_per_extract(word);
}
static inline uint32_t Wrapper_ev_pending_interrup_per_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void Wrapper_ev_pending_interrup_per_write(uint32_t plain_value) {
	uint32_t oldword = Wrapper_ev_pending_read();
	uint32_t newword = Wrapper_ev_pending_interrup_per_replace(oldword, plain_value);
	Wrapper_ev_pending_write(newword);
}
#define CSR_WRAPPER_EV_ENABLE_ADDR (CSR_BASE + 0x1cL)
#define CSR_WRAPPER_EV_ENABLE_SIZE 1
static inline uint32_t Wrapper_ev_enable_read(void) {
	return csr_read_simple(CSR_BASE + 0x1cL);
}
static inline void Wrapper_ev_enable_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x1cL);
}
#define CSR_WRAPPER_EV_ENABLE_INTERRUP_PER_OFFSET 0
#define CSR_WRAPPER_EV_ENABLE_INTERRUP_PER_SIZE 1
static inline uint32_t Wrapper_ev_enable_interrup_per_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t Wrapper_ev_enable_interrup_per_read(void) {
	uint32_t word = Wrapper_ev_enable_read();
	return Wrapper_ev_enable_interrup_per_extract(word);
}
static inline uint32_t Wrapper_ev_enable_interrup_per_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void Wrapper_ev_enable_interrup_per_write(uint32_t plain_value) {
	uint32_t oldword = Wrapper_ev_enable_read();
	uint32_t newword = Wrapper_ev_enable_interrup_per_replace(oldword, plain_value);
	Wrapper_ev_enable_write(newword);
}
