# -*- coding: utf-8 -*-
## 
# @file    03_etude_modele_tflite.py 
# @brief   Étudier l'inference d'un modèle quantizée avec tflite.
# @details Module pour imprimer les tensors et ses entrées et sorties. Il peut sert 
#          à comprendre comme l'inference est calculée avec un modèle TFLite (i.e. 
#          modèle quantizée à nombres entiers du 8-bits.
