# -*- coding: utf-8 -*-
## 
# @file    02_int_conv_ker_tf_mnist.py 
# @brief   CNN quantifié, entiers, keras avec tf et ensemble de données. 
# @details Module pour faire l'entraînement d'un CNN quantifié à nombres
#          entiers avec Keras et l'ensemble des données Mnist.
#          En plus, il permetre des sauvégarder le modèle à étudier.
