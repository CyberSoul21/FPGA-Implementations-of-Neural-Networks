...
set rc [catch {
  ...
  add_files -quiet /home/javier/Documents/fpga_implementations_of_neural_networks/CNN/02_hardware/01_test_vivado/7segment_display/7segment_display.runs/synth_1/display.dcp
  ...
  link_design -top display -part xc7z020clg400-1
