//--------------------------------------------------------------------------------
// Auto-generated by Migen (3ffd64c) & LiteX (080ecad5) on 2021-08-21 12:44:16
//--------------------------------------------------------------------------------
...
/* mult */
#define CSR_MULT_BASE (CSR_BASE + 0x0L)
#define CSR_MULT_A_ADDR (CSR_BASE + 0x0L)
#define CSR_MULT_A_SIZE 1
static inline uint32_t mult_A_read(void) {
	return csr_read_simple(CSR_BASE + 0x0L);
}
static inline void mult_A_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x0L);
}
#define CSR_MULT_B_ADDR (CSR_BASE + 0x4L)
#define CSR_MULT_B_SIZE 1
static inline uint32_t mult_B_read(void) {
	return csr_read_simple(CSR_BASE + 0x4L);
}
static inline void mult_B_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x4L);
}
#define CSR_MULT_OUT_ADDR (CSR_BASE + 0x8L)
#define CSR_MULT_OUT_SIZE 1
static inline uint32_t mult_OUT_read(void) {
